...
appBuiltin locals = curry \case
  ((Any'; Bool; Eq; Int' _; List; Never; OpaqueVal{}; PropLteTrans; PropListViewlDec; Refl; RowPlus; Tag; TypePlus; W
   ; KolEventId; KolUserId; KolMkEventType; KolUnEventType; KolGear; KolMkGear; KolQuery; KolMkQuery; KolListNew; KolListPush; KolId; KolQueryDelta; KolSenderToUser; KolMkStateGraph; KolStateGraphApply; KolStateGraphOut; KolSgCtxQuery; KolSgCtxUpdate; KolSgCtxDepQuery; KolEventTypeId; KolLocalEventId; KolTimestamp; KolLocalUserId; KolStateGraphT; KolStateGraphOutT
   ), _) → pure Nothing
